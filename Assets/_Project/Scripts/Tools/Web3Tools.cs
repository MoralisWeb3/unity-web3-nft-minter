...
namespace MoralisTools
{
    public static class Web3Tools
    {
        public static void ViewNftOnTestnetOpenSea(string contractAddress, string contractChain, string tokenId)
        {
        ...
        public static void ViewContractOnPolygonScan(string contractAddress)
        {
            string url = $"https://mumbai.polygonscan.com/address/{contractAddress}";
            Application.OpenURL(url);
        ...
        {
            MoralisUser user = await Moralis.Client.GetCurrentUser();
